...
class ProductStock(models.Model):
    ...
    product_base = models.ForeignKey('products_bases.ProductBase', on_delete=models.CASCADE, db_index=True)
    product_option_value = models.ManyToManyField('products_options_values.ProductOptionValue', db_index=True)
